      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)(res.data.status, 'Account created successfully'); //after signing up, load the home page after 1 and a half seconds
...
var logOutBtn = document.querySelector('.nav__el--logout'); //if loginForm element is on page then run loginForm function
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    console.log("Email is ".concat(email, " and Password is ").concat(password));
